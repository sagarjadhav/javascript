 ...
 * Classes also come with a new method, the constructor that creates and instantiates an object created with class.
 * Classes are able to be extended upon using the extends keyword, allowing subclasses to be created.
 * If there is a constructor present in the extended class,
 * the super keyword is needed to link the constructor to the base class.
 * You can check if something is inherited from a class by using the keyword instanceof to compare
 * the new object to the class.
 */
...
class Ogre extends Character {
	...
	enrage() {
		console.log(`double attack power`);
	}
}
